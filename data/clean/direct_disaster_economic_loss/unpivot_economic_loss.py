"""
Converts the wide-format "direct disaster economic loss" Excel file
(Country | 2007 | 2010 | ... ) into long format
...
Run from inside scripts/ — expects:
  ../source/direct_disaster_economic_loss.xlsx
Writes:
  ../output/direct_disaster_economic_loss_LONG.xlsx
"""
...
SOURCE_PATH = '../source/direct_disaster_economic_loss.xlsx'
OUTPUT_PATH = '../output/direct_disaster_economic_loss_LONG.xlsx'
SHEET_NAME = 'Sheet1'
VALUE_COLUMN_NAME = 'Economic Loss'
